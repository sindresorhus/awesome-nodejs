...
- [Danf](https://github.com/gnodi/danf) - An isomorphic OOP framework allowing to make deep architectures and handle asynchronous flows on both client-side and server-side.
