...
- [strong-build](https://github.com/strongloop/strong-build) - Build a node 
application package and prepare to deploy it as a package to production or use 
git to commit to a deploy branch.
