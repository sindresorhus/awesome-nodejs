...
- [url-pattern](https://github.com/snd/url-pattern) - Easier than regex string matching patterns for urls, domains, filepaths and other strings. Turn strings into data or data into strings.
