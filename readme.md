...
- [Feathers](http://feathersjs.com) - A minimal and flexible microservice framework built in the spirit of Express. Enabling you to build better real-time and REST APIs faster than ever.
