...
- [Gremlins.js](https://github.com/marmelab/gremlins.js) - A monkey testing library. Use it to check the robustness of web applications by  simulating random user actions
