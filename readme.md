...
- [Kraken](http://krakenjs.com/) - Kraken is a secure and scalable layer that extends express by providing structure and convention. It provides Application security(via Lusca), NPM proxy(via Kappa), I18N + L10N (via Makara and Adaro) out of the box.
