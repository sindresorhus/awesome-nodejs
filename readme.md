...
- [Tinyhttp](https://github.com/talentlessguy/tinyhttp) - Modern modern Express-like web framework compiled to native ESM and using a bare minimum amount of dependencies trying to avoid legacy hell.
