...
- [Serverless](https://serverless.com/) - Serverless Framework is a tool that allows users to build & deploy auto-scaling, pay-per-execution, event-driven functions.
