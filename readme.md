...
- [SockJS](https://github.com/sockjs) - SockJS gives you a coherent, cross-browser, Javascript API which creates a low latency, full duplex, cross-domain channel browser-server, with WebSockets or without.
