...
- [runtime-configurator](https://github.com/damlys/nodejs-runtime-configurator) – Runtime configuration management with files, environment variables and command line arguments.
