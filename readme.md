...
- [jscpd](https://github.com/kucherenko/jscpd) - Copy/paste detector for source code, supported different languages (JavaScript, TypeScript, CoffeeScript, HTML, CSS, etc.).
