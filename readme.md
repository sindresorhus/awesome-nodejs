...
- [Make a Vanilla Node.js REST API | No Framework](https://www.youtube.com/watch?v=_1xa8Bsho6A) - Intersting video about building a REST API without using a framework like express.
