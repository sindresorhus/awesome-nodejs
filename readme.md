...
- [Make a Vanilla Node.js REST API | No Framework](https://www.youtube.com/watch?v=_1xa8Bsho6A) - An intersting video about building a REST API in Node.js without using a framework like express.
