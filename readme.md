...
- ODM / ORM
	...
	- [Toshihiko](https://github.com/xadillax/toshihiko) - A simple ORM wich cache layer in Huaban, Dasouche and Sohu with :heart:. For performance, this ORM does not provide operations like in, group by, join and so on.
- Query builder
