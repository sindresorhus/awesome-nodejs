...
- [Tinyhttp](https://github.com/talentlessguy/tinyhttp) - Modern Express-like web framework compiled to native ESM and written in TypeScript that uses a bare minimum amount of dependencies trying to avoid legacy hell.
